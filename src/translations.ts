  ...
  lo: {
    ...
    team: {
      ...
      members: [
        ...
        { name: 'ຄູ ແນຣີ້ (Nery)', role: 'ຄູສອນ', bio: 'To be a teacher is not merely to share knowledge, but to sow the seeds of humility and empathy — nurturing hearts to grow into kinder souls.', img: './pingu-images/Pingu-teacher-Nery-6.webp' },
