...
export const translations = {
  en: {
    ...
    benefits: [
      { icon: '🌍', title: 'Experienced Global Leader', desc: 'A century of language teaching excellence from Linguaphone Group, combined with the playful world of Pingu\'s English.' },
      ...
      { icon: '📚', title: 'Educational Introduction', desc: 'Pingu\'s English goes beyond language to teach real life skills — Maths, Literacy, and STEM — building a strong foundation for the future.' },
      { icon: '💡', title: 'Interactive Learning', desc: 'Children learn through words, videos, and pictures using our innovative digital resources.' },
      { icon: '✅', title: 'Proven Methodology', desc: 'Our teaching is built on globally recognised methods like the EYFS, ensuring your child develops correctly.' },
      { icon: '🐧', title: 'Iconic TV Show', desc: 'Loved by over 1 billion fans, Pingu brings world-class charm to make English learning an unforgettable adventure.' }
    ],
    about: {
      title: 'Our History & School',
      historyTitle: 'History of Linguaphone',
      historyText: 'Linguaphone was founded in 1901 and is one of the most established international language education providers in the world. Over the years, millions of people in more than 60 countries have improved their careers and enhanced their lives by learning a new language with The Linguaphone Group.',
      schoolTitle: "Pingu's English School",
      schoolText: "Building on the beloved TV show, Pingu's English was developed after HIT Entertainment granted exclusive rights in 2006. With over a century of expertise, the program uses proven play-based learning and high-quality resources designed by UK experts.",
    ...
    programs: {
      ...
      activities: [
        ...
        { num: '05', title: 'Song Time', desc: "We love Song Time! We end every class with a fun Pingu song that students can sing and dance to. Our main priority is for your child to have FUN and truly ENJOY learning. By making English exciting rather than intimidating, we encourage children to stay curious. Song Time is the perfect way to keep learning active and get our students moving!", img: '/pingu-images/Pingu-img-7-SongTime.webp' },
  ...
  lo: {
    ...
    benefits: [
      { icon: '🌍', title: 'ປະສົບການລະດັບສາກົນ', desc: 'Linguaphone Group ມີປະສົບການຫຼາຍກວ່າ 100 ປີ ໃນການສິດສອນພາສາ ປະສົມປະສານກັບໂລກທີ່ໜ້າມ່ວນຂອງ Pingu\'s English.' },
      { icon: '🎨', title: 'ທັກສະການສ້າງສັນ', desc: 'ເດັກນ້ອຍຈະໄດ້ສ້າງຄວາມໝັ້ນໃຈ ແລະ ຈິນຕະນາການ ຜ່ານສິລະປະ, ການເລົ່ານິທານ, ສຽງເພງ ແລະ ການເຕັ້ນ.' },
      { icon: '📚', title: 'ພື້ນຖານການສຶກສາ', desc: 'ພວກເຮົາສອນຫຼາຍກວ່າພາສາ — ລວມທັງທັກສະຊີວິດ, ຄະນິດສາດ ແລະ ວິທະຍາສາດ (STEM) ເພື່ອປູພື້ນຖານທີ່ດີ.' },
      { icon: '💡', title: 'ການຮຽນຮູ້ແບບໂຕ້ຕອບ', desc: 'ເດັກນ້ອຍຈະໄດ້ຮຽນຮູ້ຜ່ານວິດີໂອ, ຮູບພາບ ແລະ ສື່ການຮຽນແບບດິຈິຕອລທີ່ທັນສະໄໝ.' },
      { icon: '✅', title: 'ຫຼັກສູດທີ່ໄດ້ຮັບການຮັບຮອງ', desc: 'ຫຼັກສູດຂອງພວກເຮົາອີງຕາມມາດຕະຖານ EYFS ທີ່ໄດ້ຮັບການຍອມຮັບໃນລະດັບສາກົນ.' },
      { icon: '🐧', title: 'ຕົວລະຄອນທີ່ໜ້າຮັກ', desc: 'Pingu ເປັນທີ່ຮັກຂອງເດັກນ້ອຍທົ່ວໂລກ, ເຮັດໃຫ້ການຮຽນພາສາອັງກິດເປັນການຜະຈົນໄພທີ່ບໍ່ມີວັນລືມ.' }
    ],
    about: {
      title: 'ປະຫວັດ ແລະ ໂຮງຮຽນ',
      historyTitle: 'ປະຫວັດຄວາມເປັນມາຂອງລິງກົວໂຟນ',
      historyText: 'ບໍລິສັດ Linguaphone ໄດ້ຖືກສ້າງຕັ້ງຂຶ້ນໃນປີ 1901 ແລະ ເປັນໜຶ່ງໃນຜູ້ໃຫ້ບໍລິການດ້ານການສອນພາສາທີ່ມີຊື່ສຽງໂດ່ງດັງໃນທົ່ວໂລກ. ຕະຫຼອດໄລຍະເວລາຫຼາຍປີ Linguaphone ໄດ້ຊ່ວຍໃຫ້ຜູ້ຄົນຫຼາຍລ້ານຄົນທົ່ວໂລກໄດ້ມີໂອກາດກ້າວໜ້າໃນດ້ານອາຊີບ.',
      schoolTitle: "ຫຼັກສູດພາສາອັງກິດພິນກຸ",
      schoolText: "Pingu™ ແມ່ນລາຍການໂທລະທັດທີ່ໄດ້ຮັບລາງວັນ ແລະ ເປັນທີ່ຮັກແພງຂອງທັງເດັກນ້ອຍ ແລະ ຜູ້ປົກຄອງ. ລາຍການນີ້ຖືກເລືອກມາ ຍ້ອນເນື້ອຫາທີ່ເຂົ້າເຖິງງ່າຍ ແລະ ແຝງດ້ວຍຄະຕິເຕືອນໃຈທີ່ດີ. ດ້ວຍປະສົບການທີ່ຍາວນານກວ່າໜຶ່ງສະຕະວັດຂອງ Linguaphone Group, ຫຼັກສູດນີ້ຈຶ່ງໄດ້ນຳໃຊ້ວິທີການຮຽນຜ່ານການຫຼິ້ນ ແລະ ສື່ການຮຽນທີ່ມີຄຸນະພາບ.",
    ...
    programs: {
      ...
      activities: [
        { num: '01', title: 'ການສົນທະນາ', desc: 'ຄູອາຈານຂອງພວກເຮົາບໍ່ພຽງແຕ່ສິດສອນ — ພວກເຂົາຍັງເປັນຜູ້ຊ່ຽວຊານດ້ານພັດທະນາການເດັກ ທີ່ສ້າງສານ, ໃຫ້ກຳລັງໃຈ ແລະ ສ້າງຄວາມໝ່ວນໃຫ້ນ້ອງໆຢ່າງຕໍ່ເນື່ອງ!', img: '/pingu-images/Pingu-img-3-Conversation.webp' },
        { num: '02', title: 'ເວລາເລົ່ານິທານ', desc: 'ເວລາເລົ່ານິທານແມ່ນກິດຈະກໍາທີ່ເດັກນ້ອຍມັກທີ່ສຸດ! ປຶ້ມນິທານທີ່ສວຍງາມຂອງ Pingu ຈະຊ່ວຍສ້າງຄວາມຮັກໃນການອ່ານໃຫ້ລູກ.', img: '/pingu-images/Pingu-img-4-StoryTime.webp' },
        { num: '03', title: 'ການຂຽນ', desc: 'ການຂຽນແມ່ນສ່ວນສໍາຄັນຂອງທຸກໆບົດຮຽນ. ພວກເຮົານຳພາເດັກນ້ອຍທຸກຂັ້ນຕອນ ຕັ້ງແຕ່ການຈັບດິນສໍໃນລະດັບ 1 ຈົນເຖິງການຂຽນປະໂຫຍກທີ່ຊັບຊ້ອນໃນລະດັບ 4.', img: '/pingu-images/Pingu-img-5-Writing.webp' },
        { num: '04', title: 'ເວລາຄອມພິວເຕີ', desc: 'ພວກເຮົາແນະນໍາໃຫ້ນ້ອງໆຮູ້ຈັກເທັກໂນໂລຊີ ແລະ ຊ່ວຍພວກເຂົາພັດທະນາທັກສະ IT ທີ່ຈໍາເປັນ ໃຫ້ທັນກັບໂລກດິຈິຕອລທີ່ໄວຂຶ້ນທຸກວັນ.', img: '/pingu-images/Pingu-img-6-ComputerTime.webp' },
        { num: '05', title: 'ເວລາຮ້ອງເພງ', desc: 'ພວກເຮົາຮັກເວລາຮ້ອງເພງ! ທຸກຊົ່ວໂມງຮຽນຈະຈົບລົງດ້ວຍເພງ Pingu ທີ່ໜ້າມ່ວນ ທີ່ນ້ອງໆສາມາດຮ້ອງ ແລະ ເຕັ້ນໄດ້. ເປົ້າໝາຍຂອງພວກເຮົາຄືໃຫ້ລູກ ມ່ວນ ແລະ ຮັກ ການຮຽນ!', img: '/pingu-images/Pingu-img-7-SongTime.webp' },
        { num: '06', title: 'ເວລາກິດຈະກໍາ', desc: 'ທຸກຊົ່ວໂມງຮຽນ ມີກິດຈະກໍາທີ່ຫຼາກຫຼາຍ, ລວມທັງການໃຊ້ Pingu\'s English Activity Book ຄູ່ກັບວຽກທີ່ຄູອອກແບບເອງ ເພື່ອພັດທະນາທັກສະຮອບດ້ານ.', img: '/pingu-images/Pingu-img-8-ActivityTime.webp' },
        { num: '07', title: 'ເວລາເຂົ້າສັງຄົມ', desc: 'ການເຂົ້າສັງຄົມແມ່ນສ່ວນໜຶ່ງທີ່ສໍາຄັນ! ນ້ອງໆຈະໄດ້ສົນທະນາ, ສ້າງໝູ່ໃໝ່ ແລະ ຊ່ວຍສ້າງຄວາມໝັ້ນໃຈໃຫ້ກ້າໃຊ້ພາສາອັງກິດໃນທຸກໆໂອກາດ.', img: '/pingu-images/Pingu-img-9-SocialTime.webp' }
      ]
    },
    team: {
    ...
    introSections: [
      { 
        title: 'ຫ້ອງຮຽນ', 
        desc: "ຍິນດີຕ້ອນຮັບເຂົ້າສູ່ໂລກແຫ່ງການຮຽນຮູ້ທີ່ເຕັມໄປດ້ວຍຄວາມມ່ວນຊື່ນ! ທີ່ Pingu's English Laos, ພວກເຮົາໄດ້ສ້າງສັນສະພາບແວດລ້ອມທີ່ສົດໃສ ແລະ ເປັນກັນເອງ ເພື່ອໃຫ້ລູກນ້ອຍຂອງທ່ານໄດ້ເຕີບໃຫຍ່ຢ່າງມີຄຸນນະພາບ.", 
        img: '/pingu-images/Pingu-img-2-Classroom.webp', 
        link: '#programs',
        cta: 'ຂໍ້ມູນເພີ່ມເຕີມ'
      },
      { 
        title: 'ຄູສອນ', 
        desc: "ຄູອາຈານທຸກທ່ານຢູ່ Pingu's English Laos ລ້ວນແຕ່ມີຄວາມຮູ້ຄວາມສາມາດສູງ ແລະ ມີພອນສະຫວັນເປັນພິເສດໃນການສິດສອນເດັກນ້ອຍ. ຄູຂອງພວກເຮົາບໍ່ໄດ້ມາພຽງແຕ່ບອກສອນຄວາມຮູ້ — ແຕ່ຍັງໃຫ້ກຳລັງໃຈ ແລະ ສ້າງຮອຍຍິ້ມ!", 
        img: '/pingu-images/Teachers.webp', 
        link: '#team',
        cta: 'ຂໍ້ມູນເພີ່ມເຕີມ'
      },
